 ...
 * 全局拦截器，作用所有的微服务
 * <p>
 * 1. 对请求头中参数进行处理 from 参数进行清洗 2. 重写 StripPrefix = 1,支持全局
 * <p>
 * 支持 swagger 添加 X-Forwarded-Prefix header (FSR2 已经支持，不需要自己维护)
 */

@Component
public class QrcbRequestGlobalFilter implements GlobalFilter, Ordered {
