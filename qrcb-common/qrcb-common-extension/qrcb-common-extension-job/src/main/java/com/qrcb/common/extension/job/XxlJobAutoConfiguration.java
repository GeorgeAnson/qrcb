package com.qrcb.common.extension.job;

import cn.hutool.core.util.StrUtil;
import com.qrcb.common.extension.job.properties.XxlJobProperties;
 ...
 * @Author Anson
 * @Create 2023-10-24
 * @Description xxl-job 自动装配 <br/>
 */

@Configuration(proxyBeanMethods = false)
@EnableAutoConfiguration
@ComponentScan("com.qrcb.common.extension.job.properties")
