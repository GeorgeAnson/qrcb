 ...
 * @Author Anson
 * @Create 2023-10-23
 * @Description 重写 RedisTokenStore ,主要解决 #1814 oauth2 中 client_id_to_access 数据膨胀问题 <br/>
 * @link https://github.com/spring-projects/spring-security-oauth/pull/1660
 */

public class QrcbRedisTokenStore implements TokenStore {
    ...
    public QrcbRedisTokenStore(RedisConnectionFactory connectionFactory, KeyStrResolver resolver) {
