 ...
 * @Author Anson
 * @Create 2023-10-23
 * @Description 重写 {@link com.alibaba.cloud.sentinel.feign.SentinelInvocationHandler} 支持自动降级注入 <br/>
 */

@Slf4j
public class QrcbSentinelInvocationHandler implements InvocationHandler {
    ...
    QrcbSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            QrcbSentinelInvocationHandler other = (QrcbSentinelInvocationHandler) obj;
