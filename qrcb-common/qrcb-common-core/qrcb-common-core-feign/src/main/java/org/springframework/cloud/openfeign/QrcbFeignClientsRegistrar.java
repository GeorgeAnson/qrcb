...
import com.qrcb.common.core.feign.QrcbFeignAutoConfiguration;
 ...
 * @Author Anson
 * @Create 2023-10-23
 * @Description feign 自动配置功能 from mica <br/>
 */

public class QrcbFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return QrcbFeignAutoConfiguration.class;
    }
